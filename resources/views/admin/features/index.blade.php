            ...
            <div class="col-md-12">
                ...
                <div class="box box-default collapsed-box">
                    ...
                    <div class="box-body" style="display: none;">
                        ...
                        <!-- Logo image Field -->
                        <div class="form-group col-sm-12 col-lg-12">
                            {!! Form::fileBox('base_extra[image]', 'Background Image:', isset($simpleContent) && isset($simpleContent->base_extra['image']) ? $simpleContent->base_extra['image'] : null, 'Max Dimensions: 570x570') !!}
                        </div>

                        <div class="form-group col-sm-12 col-lg-12">
                            {!! Form::label('base_extra[playstore_url]', 'Playstore URL:') !!}
                            {!! Form::text('base_extra[playstore_url]', isset($simpleContent) && isset($simpleContent->base_extra['playstore_url']) ? $simpleContent->base_extra['playstore_url'] : null, ['class' => 'form-control']) !!}
                        </div>
