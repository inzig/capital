            ...
            @foreach(config('translatable')['locales'] as $locale)
                <div class="tab-pane @if($count == 0) active @endif" id="tab_{!! $locale !!}">
                    ...
                    <div class="form-group col-sm-6 col-lg-6">
                        ...
                        {!! Form::text('translations['.$locale.'][extra][subscribe]', isset($simpleContent) && isset($simpleContent->translateOrNew($locale)->extra['subscribe']) ? $simpleContent->translateOrNew($locale)->extra['subscribe'] : null, ['class' => 'form-control', 'maxlength' => 15]) !!}
                    </div>
