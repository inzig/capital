            ...
            @foreach(config('translatable')['locales'] as $locale)
                <div class="tab-pane @if($count == 0) active @endif" id="tab_{!! $locale !!}">
                    ...
                    <div class="form-group col-sm-12 col-lg-12">
                        {!! Form::label('translations['.$locale.'][title]', 'Question:') !!}
                    ...
                    <!-- Description Field -->
                    <div class="form-group col-sm-12 col-lg-12">
                        {!! Form::label('translations['.$locale.'][description]', 'Answer:') !!}
                        {!! Form::textarea('translations['.$locale.'][description]', isset($sortableContent) ? $sortableContent->translateOrNew($locale)->description : null, ['class' => 'form-control']) !!}
                    </div>
