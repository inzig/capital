...
<div class="form-group">
    <form action={{ url('purchase') }} class="form-horizontal" id="contribute_form" method="post">
        ...
        <div class="col-sm-12 margin-bottom-field has-feedback{{ $errors->has('amount') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-9">
                <input required type="text" class="form-control amount" data-coin="bitcoin" name="amount" id="amount" value="{{ old('amount') }}" placeholder="Amount in ZEC">
            </div>
        ...
        <div class="col-sm-12 margin-bottom-field has-feedback{{ $errors->has('bitcoin_wallet') ? ' has-error' : '' }}">
            <label for="currency_wallet" class="col-sm-3 control-label text-left">ZCASH Wallet Address: </label>
            <div class="col-sm-9">
                <input required type="text" class="form-control" name="currency_wallet" id="currency_wallet" value="{{ old('currency_wallet') }}" placeholder="ZEC Wallet Address">
            </div>
        ...
        <input type="hidden" name="currency" value="ZEC">
