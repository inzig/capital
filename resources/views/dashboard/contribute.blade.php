                ...
                @if($wallets->isNotEmpty())
                    ...
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active">
                                <a href="#tab_eth" data-toggle="tab" aria-expanded="true">Ethereum</a>
                            </li>
                            <li>
                                <a href="#tab_btc" data-toggle="tab" aria-expanded="false">Bitcoin</a>
                            </li>
                            <li>
                                <a href="#tab_ltc" data-toggle="tab" aria-expanded="false">Litecoin</a>
                            </li>
                            <li>
                                <a href="#tab_cash" data-toggle="tab" aria-expanded="false">Card</a>
                            </li>
                        </ul>
