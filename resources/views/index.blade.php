	...
	<body class="background-color-body">
						...
						<ul class="nav navbar-nav pull-right">
							<li class="dropdown">
								...
								<ul class="dropdown-menu dropdown-language">
									<li><a class="change-en" href="#">EN</a></li>
									<li><a class="change-ro" href="#">RO</a></li>
		...
		<section id="roadmap" class="section gray roadmap">
			...
			<div class="road-map ready">
				<div class="container">
					<div class="road-map-block active">
					...
					<div class="road-map-block false">
					...
					<div class="tube" id="roadMapTube">
						<div class="tube-inner"></div>
						<div class="bullet road-map-bullets false"></div>
						<div class="bullet road-map-bullets false"></div>
						<div class="bullet road-map-bullets false"></div>
						<div class="bullet road-map-bullets false"></div>
						<div class="bullet road-map-bullets false"></div>
		...
		<section id="tokensale" class="tokensale-wraper">
			<div class="container">
				<div class="row tokensale-rgt-buttons">
					<div class="col-md-3 tokensale-rgt-top">
				...
				<div class="container" id="sale-table">
					<div class="row wow bounceIn" data-wow-delay="0.2s" data-aos="zoom-in-right" data-aos-duration="1000">
						<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12" id="capchartx">
							<div id="capchart" class="bannerleft-circle text-center wow fadeIn" data-wow-delay="0.2s" data-aos="zoom-in-right" data-aos-duration="1000"></div>
						</div>
						<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12" id="capcharty">
							<div class="row">
								<div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
									<h4 class="progress-name">Public Sale (CALL)</h4>
								</div>
							...
							<div class="row">
								<div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
									<h4 class="progress-name">Founder Team (CALL)</h4>
								</div>
								<div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">
									<div class="progress">
							...
							<table class="table">
								<tr>
									<th>Total Capital (CALL)</th>
									<th>105 000 000 CALL</th>
								</tr>
								<tr>
									<td>Available for Crowdsale</td>
					...
					<div class="row wow bounceIn" data-wow-delay="0.2s" data-aos="zoom-in-right" data-aos-duration="1000">
						<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12" id="capgcharty">
							<div class="row">
								<div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
									<h4 class="progress-name">Public Sale (CALLG)</h4>
								</div>
								<div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">
									<div class="progress">
										<div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width:90%">8,925,000,000 CALLG</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
									<h4 class="progress-name">Founder Team (CALLG)</h4>
								</div>
								<div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">
									<div class="progress">
										<div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width:60%">1,050,000,000 CALLG</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
									<h4 class="progress-name">Bounty Campaigns (CALLG)</h4>
								</div>
								<div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">
									<div class="progress">
										<div class="progress-bar progress-bar-striped active" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width:40%">525,000,000 CALLG</div>
									</div>
								</div>
							</div>
							<table class="table">
								<tr>
									<th>Total Capital GAS (CALLG)</th>
									<th>21 000 000 000 CALLG</th>
								</tr>
								<tr>
									<td>Available for Crowdsale</td>
						...
						<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12" id="capgchartx">
							<div id="capgchart" class="bannerleft-circle text-center wow fadeIn" data-wow-delay="0.2s" data-aos="zoom-in-right" data-aos-duration="1000"></div>
						</div>
					</div>
					<div class="row wow bounceIn" data-wow-delay="0.2s" data-aos="zoom-in-right" data-aos-duration="1000">
						<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12" id="funds-distribution">
							<div id="fund-distribution" class="bannerleft-circle text-center wow fadeIn" data-wow-delay="0.2s" data-aos="zoom-in-right" data-aos-duration="1000"></div>
						</div>
						<div class="col-md-6 col-lg-6 col-sm-12 col-xs-12" id="fundcharty">
							<div class="row">
								<div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
									<h4 class="progress-name">Advisors & Legal</h4>
								</div>
								<div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">
									<div class="progress">
							...
							<div class="row">
								<div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
									<h4 class="progress-name">Development</h4>
								</div>
								<div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">
									<div class="progress">
							...
							<div class="row">
								<div class="col-md-4 col-lg-4 col-sm-4 col-xs-4">
									<h4 class="progress-name">Marketing</h4>
								</div>
								<div class="col-md-8 col-lg-8 col-sm-8 col-xs-8">
									<div class="progress">
		...
		<section id="team" class="team_section wow fadeInDown" data-wow-delay="0.4s">
			<div class="container-fluid">
				...
				<div class="container">
					<div class="row">
						<div id="team-col" class="col-md-12 col-lg-12 col-sm-12 col-xs-12 wow fadeIn padding-col-md-6 top-team" data-wow-delay="0.2s" data-aos="zoom-in-right" data-aos-duration="1000">
							<div class="team_member col-sm-12 no-padding">
								<div class="row">
									<div class="col-md-4 col-sm-4 staff-main-col">
										<div class="img-overlay-main">
											...
											<a target="_blank" href="https://www.youtube.com/watch?v=EsV8cGlAiwY&index=7&list=PLPdzhFIKy_I0DEO_Ozx8Div4bIC96h2Ea"><img src="img/play-team.png" id="team-play" alt="VIDEO"></a>
									...
									<div class="col-md-4 col-sm-4 staff-main-col">
										<div class="img-overlay-main">
											<img src="img/team-pictures/marinescu-victor.png" class="img-responsive" alt="Image">
											<a target="_blank" href="https://www.youtube.com/watch?v=pZQQEVM1FkY&index=6&list=PLPdzhFIKy_I0DEO_Ozx8Div4bIC96h2Ea"><img src="img/play-team.png" id="team-play" alt="VIDEO"></a>
											<span class="img-overlay"></span>
											<a href="https://www.linkedin.com/in/victor-marinescu-1ba783159/"><span class="img-ovly-txt">in</span></a>
										</div>
										<p>Marinescu Victor (CTO)</p>
										<p id="justify">Victor is an application developer, hardware engineer and a solution architect with requisite experience in reports and system architecture. His expertise includes hardware and software design for embedded systems (chip, board, and system levels); high-level applications, graphical user interfaces, application program interfaces (APIs), development tools, and distribution systems. He is also a skilled expert in the areas of log analysis, database modeling, and web user interface.</p>
										<div class="text-left">
											<a href="https://web.facebook.com/victor.marinescu.101"><i class="fa fa-facebook fa-style fb" aria-hidden="true"></i></a>
											<a href="https://twitter.com/MarinescuV1ctor"><i class="fa fa-twitter fa-style twitter" aria-hidden="true"></i> </a>
										</div>
									</div>
									<div class="col-md-4 col-sm-4 staff-main-col">
										<div class="img-overlay-main">
											<img src="img/team-pictures/firu-ionut.png" class="img-responsive" alt="Image">
											<a target="_blank" href="https://www.youtube.com/watch?v=Wp154fPI7Wk&index=5&list=PLPdzhFIKy_I0DEO_Ozx8Div4bIC96h2Ea"><img src="img/play-team.png" id="team-play" alt="VIDEO"></a>
											<span class="img-overlay"></span>
											<a href="https://www.linkedin.com/in/ionut-firu-116b5915a/"><span class="img-ovly-txt">in</span></a>
										</div>
										<p>Firu Gradoe Ionuț (CXO)</p>
										...
										<div class="text-left">
											...
											<a href="https://twitter.com/ionut_firu"><i class="fa fa-twitter fa-style twitter" aria-hidden="true"></i> </a>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-4 col-sm-4 staff-main-col">
										<div class="img-overlay-main">
											<img src="img/team-pictures/stani-ionut.png" class="img-responsive" alt="Image">
											<a target="_blank" href="https://www.youtube.com/watch?v=hQ1zPl3jGrs&index=3&list=PLPdzhFIKy_I0DEO_Ozx8Div4bIC96h2Ea"><img src="img/play-team.png" id="team-play" alt="VIDEO"></a>
											<span class="img-overlay"></span>
											<a href="https://www.linkedin.com/in/stani-ionut-daniel/"><span class="img-ovly-txt">in</span></a>
										</div>
										<p>Stani Ionuț Daniel (Digital Marketing Manager)</p>
										<p id="justify">Ionuț is responsible for setting up and delivering online marketing straits, promotion on social media, finding new ways to promote company’s technology & image. He is also a marketing analyst, specialized in blockchain market research, applying research findings to optimize marketing strategies as well as enhancing search engine optimization and community engagement.</p>
										<div class="text-left">
									...
									<div class="col-md-4 col-sm-4 staff-main-col">
										<div class="img-overlay-main">
											<img src="img/team-pictures/cirjaliu-bogdan.png" class="img-responsive" alt="Image">
											<a target="_blank" href="https://www.youtube.com/watch?v=KEVFgfqwp9Y&index=4&list=PLPdzhFIKy_I0DEO_Ozx8Div4bIC96h2Ea"><img src="img/play-team.png" id="team-play" alt="VIDEO"></a>
											<span class="img-overlay"></span>
											<a href="https://www.linkedin.com/in/bogdan-dinel-56329115a/"><span class="img-ovly-txt">in</span></a>
										</div>
										<p>Cîrjaliu Bogdan Dinel (Hardware Marketing Manager) </p>
									...
									<div class="col-md-4 col-sm-4 staff-main-col">
										<div class="img-overlay-main">
											...
											<a target="_blank" href="https://www.youtube.com/watch?v=_S1OAploW4E&index=1&list=PLPdzhFIKy_I0DEO_Ozx8Div4bIC96h2Ea"><img src="img/play-team.png" id="team-play" alt="VIDEO"></a>
											<span class="img-overlay"></span>
								...
								<div class="row">
									<div class="col-md-4 col-sm-4 staff-main-col">
										<div class="img-overlay-main">
											<img src="img/team-pictures/mitroi-ionel.png" class="img-responsive" alt="Image">
											<span class="img-overlay"></span>
											<a href="https://www.linkedin.com/in/mitroi-ionel-38075615a/"><span class="img-ovly-txt">in</span></a>
										</div>
										<p>Mitroi Ionel (Cryptocurrency Advisor &amp; Investor)</p>
										<p id="justify">Ionel is a blockchain activist and an early investor in many of the ground-breaking blockchain projects, including Bitcoin, Ethereum, and many others. He is building long lasting relationships with clients to take care of their success while at the same time keeping them up to date with changes in the rules and regulations that may affect them</p>
										<div class="text-left">
											<a href="https://web.facebook.com/mitroi.ionel.5"><i class="fa fa-facebook fa-style fb" aria-hidden="true"></i></a>										
										</div>
									</div>
									<div class="col-md-4 col-sm-4 staff-main-col">
										<div class="img-overlay-main">
											<img src="img/team-pictures/piciorus-marti.png" class="img-responsive" alt="Image">
											<a target="_blank" href="https://www.youtube.com/watch?v=MqoSpIpMolM&index=2&list=PLPdzhFIKy_I0DEO_Ozx8Div4bIC96h2Ea"><img src="img/play-team.png" id="team-play" alt="VIDEO"></a>
											<span class="img-overlay"></span>
											<a href="https://www.linkedin.com/in/marti-piciorus-b9a02b82/"><span class="img-ovly-txt">in</span></a>
										</div>
										<p>Picioruș Marti (Advisor & Investor)</p>
									...
									<div class="col-md-4 col-sm-4 staff-main-col">
										<div class="img-overlay-main">
											<img src="img/team-pictures/smaranda-eliza.png" class="img-responsive" alt="Image">
											<span class="img-overlay"></span>
											<a href="https://www.linkedin.com/in/mucioniu-eliza-smaranda-90880940/"><span class="img-ovly-txt">in</span></a>
										</div>
										<p>Eliza Smaranda Mucioniu (Security Advisor & Investor)</p>
										<p id="justify">Eliza is a security expert focused on blockchain technology. She is Bitcoin enthusiast with a background in cyber security and technology management.</p>
										<div class="text-left">
											<a href="https://web.facebook.com/profile.php?id=1142077837"><i class="fa fa-facebook fa-style fb" aria-hidden="true"></i></a>
										</div>
									</div>
								</div>
								<div class="row">
									...
									<div class="col-md-3 col-sm-3 staff-main-col">
										<div class="img-overlay-main">
											<img src="img/team-pictures/shahid.png" class="img-responsive" alt="Image">
											<span class="img-overlay"></span>
											<a href="https://www.linkedin.com/in/shahid-shaukat/"><span class="img-ovly-txt">in</span></a>
										</div>
										<p>Shahid Shoukat (Software Engineer)</p>
										<p id="justify">Shahid is an experienced frontend and backend web developer. He has experience in working on Open Source technologies for more than 10 years, he has developed and designed architecture of numerous web applications.</p>
										<div class="text-left">
											<a href="https://www.facebook.com/shahidss"><i class="fa fa-facebook fa-style fb" aria-hidden="true"></i></a>
											<a href="https://github.com/shahid80"><i class="fa fa-github fa-style fb" aria-hidden="true"></i></a>
										</div>
									</div>
									<div class="col-md-3 col-sm-3 staff-main-col">
										<div class="img-overlay-main">
											<img src="img/team-pictures/fung-su-jung-gu.png" class="img-responsive" alt="Image">
										</div>
										<p>Fung Su Jung Gu (Blockchain Developer and China Official Representative)</p>
										<p id="justify">Fung is a TCP/IP Network Expert and a Server Programmer. He is an App Developer with more than seven years of experience in Network Security & Management, Windows & Linux Server Programming, Service Management - Assembly X86/64, and Reverse Engineering</p>
									</div>
								</div>
							</div>
						</div>
		...
		<section id="photo-gallery" class="wow fadeInDown" data-aos="zoom-in-right" data-aos-duration="1000">
			<div class="row">
				<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
					<div class='container-fluid container-gallery'>
						<img class='map map-1' src="img/photo-gallery/conference-3.jpg"></img>
						<img class='map map-2' src="img/photo-gallery/handshake-ceo-adv.jpg"></img>
						<img class='map map-3' src="img/photo-gallery/ceo-desk.jpg"></img>
						<img class='map map-4' src="img/photo-gallery/john-desk.jpg"></img>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
					<div class='container-fluid container-gallery'>
						<img class='map map-1' src="img/photo-gallery/outside.jpg"></img>
						<img class='map map-2' src="img/photo-gallery/conference-2.jpg"></img>
						<img class='map map-3' src="img/photo-gallery/team.jpg"></img>
						<img class='map map-4' src="img/photo-gallery/conference-1.jpeg"></img>
					</div>
				</div>
			</div>
		</section>
		<div id="photoModal" class="modal-img">
						...
						<div id="press-1" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								<div class="item active">
									<div class="row">
										<div class="col-md-2"><a href="http://www.nbcrightnow.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/f7iH4x/nbcrightnow_com.png" alt="nbcrightnow_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://thelajournal.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/nNoQPx/thelajournal_com.png" alt="thelajournal_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://thenjnewsjournal.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/gnW1xH/thenjnewsjournal_com.png" alt="thenjnewsjournal_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://thenyjournal.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/cTRZHH/thenyjournal_com.png" alt="thenyjournal_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://thenynewsjournal.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/jJAuHH/thenynewsjournal_com.png" alt="thenynewsjournal_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://southafricabulletin.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/eAJgxH/southafricabulletin_com.png" alt="Image" style="width:250px; height:100%;"></a></div>
									</div>
								</div>
								<div class="item">
									<div class="row">
										<div class="col-md-2"><a href="http://thesanfranciscopost.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/mMUX4x/thesanfranciscopost_com.png" alt="thesanfranciscopost_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://switzerlandposts.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/kfQiBc/switzerlandposts_com.png" alt="switzerlandposts_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://thechicagonewsjournal.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/jKoQPx/thechicagonewsjournal_com.png" alt="thechicagonewsjournal_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://thedenverjournal.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/nuuzjx/thedenverjournal_com.png" alt="thedenverjournal_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://thedenvernewsjournal.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/kENkPx/thedenvernewsjournal_com.png" alt="thedenvernewsjournal_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://thephiladelphianewsjournal.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/cR4X4x/thephiladelphianewsjournal_com.png" alt="thephiladelphianewsjournal_com" style="width:250px; height:100%;"></a></div>
									</div>
								</div>
								<div class="item">
									<div class="row">
										<div class="col-md-2"><a href="http://aussieheadlines.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/csXc4x/aussieheadlines_com.png" alt="aussieheadlines_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://business-prnews.com/business_articles/2018/04/capital-technologies-research-will-revolutionise-our-means-of-communication-452491.htm" target="_blank" class="thumbnail"><img src="https://image.ibb.co/j5PqPx/Business_PR_News_com.png" alt="Business_PR_News_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://business.bentoncourier.com/bentoncourier/news/read/36082154/Capital_Technologies_&_Research_Will_Revolutionise_Our_Means_of_Communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/ixo6xH/business_bentoncourier_com.png" alt="business_bentoncourier_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.760kfmb.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/bXmFrc/760kfmb_com.png" alt="760kfmb_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://allindiabulletin.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/iMVarc/allindiabulletin_com.png" alt="allindiabulletin_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://atltimes.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/nEkmxH/atltimes_com.png" alt="atltimes_com" style="width:250px; height:100%;"></a></div>
									</div>
								</div>
								<div class="item">
									<div class="row">
										<div class="col-md-2"><a href="http://www.doublet973.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/c2JEHH/doublet973_com.png" alt="doublet973_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.sandiegojack.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication " target="_blank" class="thumbnail"><img src="https://image.ibb.co/kukGWc/kfmbfm_com.png" alt="kfmbfm_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.kptv.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/hpLTcH/kptv_com.png" alt="kptv_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.wafb.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/iFzMxH/wafb_com.png" alt="wafb_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://business.dailytimesleader.com/dailytimesleader/news/read/36082154/Capital_Technologies_&_Research_Will_Revolutionise_Our_Means_of_Communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/ffigxH/business_dailytimesleader_com.png" alt="business_dailytimesleader_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.cleveland19.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/iGXwWc/cleveland19_com.png" alt="cleveland19_com" style="width:250px; height:100%;"></a></div>
									</div>
								</div>
							</div>
					...
					<div class="col-md-12">
						<div id="press-2" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								<div class="item active">
									<div class="row">
										<div class="col-md-2"><a href="http://www.kcbd.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/cqcS4x/kcbd_com.png" alt="kcbd_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.kctv5.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/e01WWc/kctv5_com.png" alt="kctv5_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.kitv.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/mioBWc/kitv_com.png" alt="kitv_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.kplctv.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/g6opHH/kplctv_com.png" alt="kplctv_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.hawaiinewsnow.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/ddE74x/hawaiinewsnow_com.png" alt="hawaiinewsnow_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.kait8.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/c0RbxH/kait8_com.png" alt="kait8_com" style="width:250px; height:100%;"></a></div>
									</div>
								</div>
								<div class="item">
									<div class="row">
										<div class="col-md-2"><a href="http://markets.financialcontent.com/bostonherald/news/read/36082154" target="_blank" class="thumbnail"><img src="https://image.ibb.co/mYMn4x/www_bostonherald_com.png" alt="www_bostonherald_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://columbusnewsjournal.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/iSOOcH/columbusnewsjournal_com.png" alt="columbusnewsjournal_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.kfvs12.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/d5rWWc/kfvs12_com.png" alt="kfvs12_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://markets.siliconinvestor.com/siliconinvestor/news/read/36082154 " target="_blank" class="thumbnail"><img src="https://image.ibb.co/hTyZjx/markets_siliconinvestor_com.png" alt="markets_siliconinvestor_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://minneapolisnewsjournal.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication " target="_blank" class="thumbnail"><img src="https://image.ibb.co/c5fQrc/minneapolisnewsjournal_com.png" alt="minneapolisnewsjournal_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://quotes.fatpitchfinancials.com/fatpitch.financials/news/read/36082154" target="_blank" class="thumbnail"><img src="https://image.ibb.co/fBdpHH/quotes_fatpitchfinancials_com.png" alt="quotes_fatpitchfinancials_com" style="width:250px; height:100%;"></a></div>
									</div>
								</div>
								<div class="item">
									<div class="row">
										<div class="col-md-2"><a href="http://thelondonnewsjournal.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication " target="_blank" class="thumbnail"><img src="https://image.ibb.co/hJJ0Px/thelondonnewsjournal_com.png" alt="thelondonnewsjournal_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://business.bigspringherald.com/bigspringherald/news/read/36082154/Capital_Technologies_&_Research_Will_Revolutionise_Our_Means_of_Communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/c9oZjx/business_bigspringherald_com.png" alt="business_bigspringherald_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.noticiasetx.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/hBMLPx/noticiasetx_com.png" alt="noticiasetx_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://theatlnewsjournal.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/bYOZjx/theatlnewsjournal_com.png" alt="theatlnewsjournal_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.cbs8.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/gY7wWc/cbs8_com.png" alt="cbs8_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://thelanewsjournal.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication " target="_blank" class="thumbnail"><img src="https://image.ibb.co/kKrLPx/thelanewsjournal_com.png
											" alt="thelanewsjournal_com" style="width:250px; height:100%;"></a></div>
									</div>
								</div>
								<div class="item">
									<div class="row">
										<div class="col-md-2"><a href="http://www.kmov.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication " target="_blank" class="thumbnail"><img src="https://image.ibb.co/jBgZHH/kmov_com.png" alt="kmov_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://thebaltimorenewsjournal.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/hzkuHH/thebaltimorenewsjournal_com.png" alt="thebaltimorenewsjournal_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.wtol.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/msmOBc/wtol_com.png" alt="wtol_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://business.dptribune.com/dptribune/news/read/36082154" target="_blank" class="thumbnail"><img src="https://image.ibb.co/m0Gejx/business_dptribune_com.png" alt="business_dptribune_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://hitechnewsarticles.com/technology_articles/2018/04/capital-technologies-research-will-revolutionise-our-means-of-communication-452491.htm" target="_blank" class="thumbnail"><img src="https://image.ibb.co/eSWqrc/business_newsarticles_com.png" alt="business_newsarticles_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.khq.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/g9fGWc/khq_com.png
											" alt="khq_com" style="width:250px; height:100%;"></a></div>
									</div>
								</div>
							</div>
					...
					<div class="col-md-12">
						<div id="press-3" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								<div class="item active">
									<div class="row">
										<div class="col-md-2"><a href="http://www.tucsonnewsnow.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/jMRn4x/tucsonnewsnow_com.png" alt="tucsonnewsnow_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.abcfoxmontana.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/fO0Ejx/abcfoxmontana_com.png" alt="abcfoxmontana_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://themiaminewsjournal.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/iYWn4x/themiaminewsjournal_com.png" alt="themiaminewsjournal_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://thephiladelphiajournal.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/hmGbxH/thephiladelphiajournal_com.png" alt="thephiladelphiajournal_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.newschannel6now.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/eN3pHH/newschannel6now_com.png" alt="newschannel6now_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.newschannel10.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/dM5Qrc/newschannel10_com.png" alt="newschannel10_com" style="width:250px; height:100%;"></a></div>
									</div>
								</div>
								<div class="item">
									<div class="row">
										<div class="col-md-2"><a href="http://englandheadlines.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/g9F0rc/englandheadlines_com.png" alt="englandheadlines_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://markets.financialcontent.com/investplace/news/read/36082154/Capital_Technologies_&_Research_Will_Revolutionise_Our_Means_of_Communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/fbt9jx/investorplace_com.png" alt="investorplace_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://business.borgernewsherald.com/borgernewsherald/news/read/36082154" target="_blank" class="thumbnail"><img src="https://image.ibb.co/iDUh4x/business_borgernewsherald_com.png" alt="business_borgernewsherald_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://business.decaturdailydemocrat.com/decaturdailydemocrat/news/read/36082154/Capital_Technologies_&_Research_Will_Revolutionise_Our_Means_of_Communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/f94tBc/business_decaturdailydemocrat_com.png" alt="business_decaturdailydemocrat_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://clevelandpulse.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/gCLBxH/clevelandpulse_com.png" alt="clevelandpulse_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.digitaljournal.com/pr/3725287" target="_blank" class="thumbnail"><img src="https://image.ibb.co/idz4HH/digitaljournal_com.png" alt="digitaljournal_com" style="width:250px; height:100%;"></a></div>
									</div>
								</div>
								<div class="item">
									<div class="row">
										<div class="col-md-2"><a href="http://thenumbers.marketplace.org/publicradio/news/read/36082154" target="_blank" class="thumbnail"><img src="https://image.ibb.co/nmsGxH/thenumbers_marketplace_org.png" alt="thenumbers_marketplace_org" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://finance.azcentral.com/azcentral/news/read/36082154" target="_blank" class="thumbnail"><img src="https://image.ibb.co/eXXGxH/finance_azcentral_com.png" alt="finance_azcentral_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://finance.dailyherald.com/dailyherald/news/read/36082154/Capital_Technologies_&_Research_Will_Revolutionise_Our_Means_of_Communication " target="_blank" class="thumbnail"><img src="https://image.ibb.co/nGGLPx/finance_dailyherald_com.png" alt="finance_dailyherald_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://markets.financialcontent.com/dailypennyalerts/news/read/36082154" target="_blank" class="thumbnail"><img src="https://image.ibb.co/fqH5rc/financialcontent_com.png" alt="financialcontent_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://markets.financialcontent.com/franklincredit/news/read/36082154" target="_blank" class="thumbnail"><img src="https://image.ibb.co/g1afPx/franklincredit_com.png" alt="franklincredit_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://business.inyoregister.com/inyoregister/news/read/36082154/Capital_Technologies_&_Research_Will_Revolutionise_Our_Means_of_Communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/ivOZjx/inyoregister_com.png
											" alt="inyoregister_com" style="width:250px; height:100%;"></a></div>
									</div>
								</div>
								<div class="item">
									<div class="row">
										<div class="col-md-2"><a href="http://technologyprnews.com/technology_articles/2018/04/capital-technologies-research-will-revolutionise-our-means-of-communication-452491.htm " target="_blank" class="thumbnail"><img src="https://image.ibb.co/gv5dcH/technologyprnews_com.png" alt="technologyprnews_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.myfoxal.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication " target="_blank" class="thumbnail"><img src="https://image.ibb.co/fYh24x/wbrc_com.png" alt="wbrc_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://www.kltv.com/story/37901379/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/hUDmWc/kltv_com.png" alt="kltv_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://markets.financialcontent.com/1discountbrokerage/news/read/36082154" target="_blank" class="thumbnail"><img src="https://image.ibb.co/dcmUjx/markets_financialcontent_com1.png" alt="markets_financialcontent_com1" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://markets.financialcontent.com/dowtheoryletters/news/read/36082154" target="_blank" class="thumbnail"><img src="https://image.ibb.co/fLMJcH/markets_financialcontent_com.png" alt="markets_financialcontent_com" style="width:250px; height:100%;"></a></div>
										<div class="col-md-2"><a href="http://news-chicago.com/Technology/capital-technologies-research-will-revolutionise-our-means-of-communication" target="_blank" class="thumbnail"><img src="https://image.ibb.co/gjGUjx/news_chicago_com.png" alt="news_chicago_com" style="width:250px; height:100%;"></a></div>
									</div>
								</div>
							</div>
		...
		<section id="map">
			...
			<div class="row">
				<div id="company-address" class="col-md-12 col-lg-12 col-sm-12 col-xs-12 text-center">
					<h2>Capital Technologies & Research SRL</h2>
					<h4>220233 Drobeta-Turnu-Severin, Mehedinti, Romania</h4>
						...
						<div class="row">
							<div class="col-md-7 col-lg-7 pull-right col-sm-12 col-xs-12 margin-top-10 border-newsletter text-center contact-main-cont">
								...
								<div class="follow-us-line-height text-left">
									<a target="_blank" href="https://fb.me/capital.technologies.research"><i class="fa fa-facebook fa-style fb" aria-hidden="true"></i></a>
									<a target="_blank" href="https://twitter.com/capital_company"><i class="fa fa-twitter fa-style twitter" aria-hidden="true"></i> </a>
									<a target="_blank" href="https://www.youtube.com/channel/UCsw0ulVPOJKGkDeW9aRhCpg"><i class="fa fa-youtube fa-style fb" aria-hidden="true"></i></a>
									<a target="_blank" href="https://t.me/capital_technologies"><i class="fa fa-telegram fa-style telegram" aria-hidden="true"></i></a>
									<a target="_blank" href="https://www.reddit.com/r/CapitalTechnologies/"><i class="fa fa-reddit fa-style reddit" aria-hidden="true"></i> </a>
									<a target="_blank" href="https://www.linkedin.com/company/capital-tech/"><i class="fa fa-linkedin fa-style reddit" aria-hidden="true"></i> </a>
									<a target="_blank" href="https://github.com/capital-technologies"><i class="fa fa-github fa-style git" aria-hidden="true"></i></a>
									<a target="_blank" href="https://bitcointalk.org/index.php?topic=3270130.100"><i class="fa fa-bitcoin fa-style bitcoin" aria-hidden="true"></i> </a>
									<a class="cstm-icon-ftr" target="_blank" href="https://medium.com/@mycapitalco.in"><img src="img/cstm-icon.png" alt="Medium" class="fa-style fa"></a>
								</div>
							</div>
						</div>
					</div>
		...
		<div id="privacyModal" class="modal">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<ol>
						...
						<li>
							...
							<ol type="a">
								...
								<li>Information we receive from other This is information we receive about you from public domain, third parties or other websites we operate or the other services we provide. Third parties we work with include: business partners, sub- contractors in technical, payment and delivery services, advertising networks, analytics providers, search information providers and credit reference agencies).</li>
							</ol>
						</li>
					</ol>
					</p>
					<b>COOKIES</b>
					<p>Our website uses cookies. A cookie is a small file of letters and numbers that we put on your computer if you agree. These cookies allow us to distinguish you from other users of our website, which helps us to provide you with a good experience when you browse our website and also allows us to improve our site. The cookies we use are session or time-based. However, if you wish you can change your cookie settings in your browser if you would like to prevent any cookies being stored on your online enabled device, but be aware that this may severely impact the functionality of the site.</p>
					...
					<p>You represents and acknowledges that we use information held about you in the following ways:
					<ol>
						<li>
							Information you give to We will use this information:
							<ol type="a">
								<li>To carry out our obligations arising from any contracts entered into between us and to provide you with the information, products and services that you request from us</li>
								...
								<li>To provide you, or permit selected third parties to provide you, with information about goods or services we feel may interest</li>
								<li>To notify you about changes to our service</li>
								<li>To ensure that content from our site is presented in the most effective manner for you </li>
							</ol>
						</li>
						<li>
							Information we collect about We will use this information:
							<ol type="a">
								...
								<li>To make suggestions and recommendations to you and other users of our site about goods or services that may interest you</li>
							</ol>
						</li>
						<li>Information we receive from other We will combine this information with information you give to us and information we collect about you and (depending on the types of information we receive) use it as described above.</li>
					</ol>
					</p>
					<b>DISCLOSURE OF YOUR INFORMATION</b>
					<p>You agree that we have the right to share your personal information with:
					<ol>
						<li>
							Any member of our group, which means our subsidiaries, our ultimate holding company and its selected third parties including:
							<ol type="a">
								...
								<li>Fraud and crime prevention agencies for the purpose of assessing the risk of crime, fraud and money laundering and this is a condition of us entering into any contract</li>
							</ol>
						</li>
					</ol>
					</p>
					...
					<ul>
						<li>
							...
							<ol>
								...
								<li>To ensure that the underlying network that will be developed pursuant to the Token Sale and/or on which the Tokens are intended to be usable has sufficient and relevant information in order to support you</li>
								<li>In order to provide relevant information to regulators, government agencies and banks that may request information on the Token</li>
							</ol>
						</li>
					</ul>
					</p>
					<b>WHERE WE STORE YOUR PERSONAL DATA</b>
					<p>All information you provide to us is stored on our and our partners performing know-your-client services servers.</p>
					<p>The data that we collect from you may be transferred to, and stored at, a destination outside Switzerland. It may be processed by staff operating outside Switzerland who works for us or for one of our suppliers. This includes staff engaged in, among other things, the fulfillment of your order, the processing of your payment details and the provision of support services. By submitting your personal data, you agree to this transfer, storing or processing. We will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this policy.</p>
					<p>Unfortunately, the transmission of information via the Internet is not completely secure. Although we will do our best to protect your personal data, we cannot guarantee the security of your data transmitted to our site; any transmission is at your own risk. Once we have received your information, we will use strict procedures and security features to try to prevent unauthorized access.</p>
					<b>YOUR RIGHTS</b>
					<p>You have the right to ask us not to process your personal data for marketing purposes. You can exercise the right at any time by contacting us at <a href="mailto:office@mycapitalco.in">office@mycapitalco.in</a>. Our site may, from time to time, contain links to and from the websites of our partner networks, advertisers and affiliates. If you follow a link to any of these websites, please note that these websites have their own privacy policies and that we do not accept any responsibility or liability for these policies. Please check these policies before you submit any personal data to these websites.</p>
					...
					<b>CONTACT</b>
					<p>Questions, comments and requests regarding this privacy policy are welcomed and should be addressed to <a href="mailto:office@mycapitalco.in">office@mycapitalco.in</a>.</p>
				</div>
			</div>
		</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<ol>
						...
						<li>
							Commencement and Duration of Token Sale<br>
						...
						<li>
							CALL/CALLG Pricing & Issuance<br>
						...
						<li>
							Capital Technologies & Research SRL Team Will Not Make Investments During ICO<br>
		...
		<script type="text/javascript">
			...
			s1.async=true;
			s1.src='https://embed.tawk.to/5ad10403d7591465c7097d3c/default';
			s1.charset='UTF-8';
